...
(function () {
  ...
  Factory.$inject = ['otusjs.staticVariable.SurveyStaticVariableFactory'];
...
(function () {
  ...
  angular.module('otusjs.staticVariable').factory('otusjs.staticVariable.SurveyStaticVariableFactory', Factory);
