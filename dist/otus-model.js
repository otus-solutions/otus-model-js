...
(function () {
   ...
   angular.module('otusjs.laboratory', ['otusjs.laboratory.participant', 'otusjs.laboratory.configuration', 'otusjs.laboratory.transportation', 'otusjs.laboratory.exam', 'otusjs.laboratory.laboratoryCrud']);
})();
'use strict';
...
(function () {
  ...
  angular.module('otusjs.laboratory.laboratoryCrud', []);
})();
'use strict';
...
(function () {
  ...
  angular.module('otusjs.model.activity').factory('otusjs.model.activity.ActivityBasicFactory', Factory);
...
(function () {
  ...
  angular.module('otusjs.model.activity').constant('ACTIVITY_CONSTANTS', {
...
(function () {
  ...
  Factory.inject = ['ACTIVITY_CONSTANTS'];
...
(function () {
  ...
  angular.module('otusjs.model.activity').factory('otusjs.model.activity.GroupOfflineActivityCollection', Factory);

  Factory.$inject = ['otusjs.model.activity.OfflineActivityCollection', 'ObjectId'];
  ...
  function GroupOfflineActivityCollection(jsonObject, OfflineActivityCollection, ObjectId) {
    ...
    var OBJECT_TYPE = 'OfflineActivityCollection';
...
(function () {
  ...
  Factory.$inject = ['otusjs.model.activity.ActivityStatusFactory', 'ACTIVITY_CONSTANTS'];
...
(function () {
  ...
  angular.module('otusjs.laboratory.laboratoryCrud').factory('otusjs.laboratory.laboratoryCrud.LaboratoryConfigurationFactory', factory);
  ...
  function LaboratoryConfiguration(participantLaboratory) {
    ...
    function buildLaboratory(groups, tubes, moments, aliquots, codeConfiguration, aliquotCenterDescriptors, laboratoryMaterialConfiguration) {
    ...
    function _buildAliquotsDescriptors(aliquots) {
      aliquots = aliquots.map(function (aliquot) {
        return {
    ...
    function _buildAliquotCenterDescriptors(aliquotCenterDescriptors) {
      self.aliquotConfiguration.aliquotCenterDescriptors = aliquotCenterDescriptors.map(function (descriptor) {
        return {
    ...
    function _buildAliquotGroupDescriptors(groups) {
      var aliquotGroupDescriptor = groups.map(function (group) {
        return {
      ...
      self.aliquotConfiguration.aliquotCenterDescriptors.forEach(function (centerDescriptor) {
        centerDescriptor.aliquotGroupDescriptors = aliquotGroupDescriptor;
      });
    }

    function _buildAliquotMomentDescriptors(groups) {
      var groupMoments = groups.map(function (group) {
        return {
          name: group.type,
          moments: _distinct(group.tubeSet, 'moment')
        };
      });
      self.aliquotConfiguration.aliquotCenterDescriptors.forEach(function (aliquotCenter) {
        aliquotCenter.aliquotGroupDescriptors.forEach(function (aliquotGroup) {
          groupMoments.forEach(function (groupMoment) {
            if (aliquotGroup.name === groupMoment.name) {
              aliquotGroup.aliquotMomentDescriptors = groupMoment.moments.map(function (moment) {
                return {
    ...
    function _buildAliquotTypesDescriptors(laboratoryMaterialConfigs) {
      laboratoryMaterialConfigs.forEach(function (laboratoryMaterialConfig) {
        self.aliquotConfiguration.aliquotCenterDescriptors.forEach(function (center) {
          center.aliquotGroupDescriptors.forEach(function (group) {
            if (group.name === laboratoryMaterialConfig.group.name) {
              group.aliquotMomentDescriptors.forEach(function (moment) {
    ...
    function _structAliquotTypesDescriptor(laboratoryMaterialConfig) {
      return {
        ...
        aliquots: laboratoryMaterialConfig.tube.aliquots.map(function (aliquot) {
          return {
            name: aliquot.name,
            role: aliquot.type
          };
    ...
    function _distinct(arr, key) {
      return Object.keys(arr.reduce(function (acc, curr) {
...
(function () {
  ...
  angular.module('otusjs.model.participant').factory('otusjs.model.participant.ParticipantContactAttemptConfigurationFactory', Factory);
...
(function () {
  ...
  angular.module('otusjs.model.participant').factory('otusjs.model.participant.ParticipantContactAttemptFactory', Factory);
...
(function () {
  ...
  angular.module('otusjs.model.participant').factory('otusjs.model.participantContact.ParticipantContactFactory', Factory);
  ...
  function ParticipantContact(participantContact) {
    var self = this;
    var email = participantContact.email || "";
    var phoneNumber = participantContact.phoneNumber || "";
    var address = participantContact.address || "";
...
(function () {
  ...
  angular.module("otusjs.user.permission").factory("otusjs.user.permission.ActivityPermissionFactory", Factory);
...
(function () {
  ...
  angular.module("otusjs.user.permission").factory("otusjs.user.permission.MonitoringPermissionFactory", Factory);
...
(function () {
  ...
  angular.module("otusjs.user.permission").factory("otusjs.user.permission.ParticipantPermissionFactory", Factory);
...
(function () {
  ...
  Service.$inject = ['otusjs.user.permission.SurveyGroupPermissionFactory', 'otusjs.user.permission.LaboratoryPermissionFactory', 'otusjs.user.permission.ActivityPermissionFactory', 'otusjs.user.permission.MonitoringPermissionFactory', 'otusjs.user.permission.ParticipantPermissionFactory'];
...
(function () {
  ...
  function TubeCollectionData(collectionInfo) {
    ...
    function removeCustomMetadata(customMetadataId) {
      self.customMetadata = self.customMetadata.filter(function (id) {
        return id !== customMetadataId;
      });
    }
