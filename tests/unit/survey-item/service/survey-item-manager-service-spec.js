describe('SurveyItemManagerService', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      ...
      service = _$injector_.get('SurveyItemManagerService', injections);
    });
  });
  ...
  describe('isAvailableCustomID method', function() {
    ...
    beforeEach(function() {
      Mock.SurveyItemContainerService.manageItems([Mock.itemOne, Mock.itemTwo, Mock.itemThree, Mock.itemFour, Mock.itemFive]);
    });

    it('should return true if does not exists a item or a checkboxAnswerOption with a passed id', function() {
      expect(service.getItemPosition('Q3')).toBe(2);
    });
  ...
  function mockSurveyItemContainerService($injector) {
    ...
    injections.SurveyItemContainerService = Mock.SurveyItemContainerService;
    ...
    spyOn(Mock.SurveyItemContainerService, 'getItemPosition').and.callThrough();
  }
