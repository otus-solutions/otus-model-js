describe('FutureDateValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('FutureDateValidatorFactory');
    });

  });

  describe('FutureDateValidatorFactory.create()', function() {
  ...
  describe("FutureDateValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.FutureDateValidatorFactory.fromJson() " +
