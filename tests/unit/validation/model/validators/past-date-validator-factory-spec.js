describe('PastDateValidatorFactory validator suite:', function() {
  ...
  describe('PastDateValidatorFactory.create()', function() {
  ...
  describe("PastDateValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.PastDateValidatorFactory.fromJson() " +
