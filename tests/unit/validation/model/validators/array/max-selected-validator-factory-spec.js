describe('otusjs.model.validation.MaxSelectedValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('otusjs.model.validation.MaxSelectedValidatorFactory');
    });
  ...
  describe("fromJsonObject method", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.validation.MaxSelectedValidatorFactory.fromJsonObject() " +
