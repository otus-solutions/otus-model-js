describe('AlphanumericValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('AlphanumericValidatorFactory');
    });

  });

  describe('AlphanumericValidatorFactory.create()', function() {
  ...
  describe("AlphanumericValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.AlphanumericValidatorFactory.fromJson() " +
