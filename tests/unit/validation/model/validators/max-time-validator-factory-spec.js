describe('MaxTimeValidatorFactory validator suite:', function() {
  ...
  describe('MaxTimeValidatorFactory.create()', function() {
  ...
  describe("MaxTimeValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.MaxTimeValidatorFactory.fromJson() " +
