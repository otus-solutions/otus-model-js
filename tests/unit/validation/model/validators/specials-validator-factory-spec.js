describe('SpecialsValidatorFactory validator suite:', function() {
  ...
  describe('SpecialsValidatorFactory.create()', function() {
  ...
  describe("SpecialsValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.SpecialsValidatorFactory.fromJson() " +
