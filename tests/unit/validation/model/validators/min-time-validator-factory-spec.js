describe('MinTimeValidatorFactory validator suite:', function() {
  ...
  describe('MinTimeValidatorFactory.create()', function() {
  ...
  describe("MinTimeValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.MinTimeValidatorFactory.fromJson() " +
