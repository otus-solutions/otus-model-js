describe('PrecisionValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('PrecisionValidatorFactory');
    });

  });

  describe('PrecisionValidatorFactory.create()', function() {
  ...
  describe("PrecisionValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.PrecisionValidatorFactory.fromJson() " +
