describe('MaxLengthValidatorFactory validator suite:', function() {
  ...
  describe('MaxLengthValidatorFactory.create()', function() {
  ...
  describe("MaxLengthValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.MaxLengthValidatorFactory.fromJson() " +
