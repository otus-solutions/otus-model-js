describe('UpperCaseValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('UpperCaseValidatorFactory');
    });

  });

  describe('UpperCaseValidatorFactory.create()', function() {
  ...
  describe("UpperCaseValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.UpperCaseValidatorFactory.fromJson() " +
