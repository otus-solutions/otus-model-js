describe('DistinctValidatorFactory validator suite:', function() {
  ...
  describe('DistinctValidatorFactory.create()', function() {
  ...
  describe("DistinctValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.DistinctValidatorFactory.fromJson() " +
