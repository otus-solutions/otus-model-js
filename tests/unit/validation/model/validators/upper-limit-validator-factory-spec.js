describe('UpperLimitValidatorFactory validator suite:', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      factory = _$injector_.get('UpperLimitValidatorFactory');
    });

  });

  describe('UpperLimitValidatorFactory.create()', function() {
  ...
  describe("UpperLimitValidatorFactory.fromJson(json)", function() {
    ...
    it("should throw a error if the method receive a string", function() {
      ...
      }).toThrowError("otusjs.model.misc.model.UpperLimitValidatorFactory.fromJson() " +
