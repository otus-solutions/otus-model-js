describe('Route', function() {
    ...
    describe('listConditions method', function() {
      ...
      it('should return a clone of original object of conditions',
        function() {
          ...
          expect(Object.keys(clone).length).not.toBe(Object.keys(
            route.listConditions()).length);
        });
  ...
  describe('equals method', function() {
    ...
    it(
      ...
      function() {
        ...
        var routeB = factory.createAlternative(ORIGIN, DESTINATION, [
          Mock.conditionA, Mock.conditionA
        ]);

        expect(routeA).not.toEqual(routeB);
      });
  ...
  function mockCondition($injector) {
    ...
    var conditionFactory = $injector.get(
