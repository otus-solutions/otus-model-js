describe('TextRuleTestService', function() {
  ...
  beforeEach(function() {
    ...
    inject(function(_$injector_) {
      service = _$injector_.get(
        'otusjs.model.activity.TextRuleTestService', Injections);
    });
  });
  ...
  describe('run method', function() {
    ...
    describe('when inputed answer is an Integer', function() {
      ...
      describe('equal cases', function() {
        ...
        describe(
          'when answer is exactly equal to rule reference',
          function() {
        ...
        describe(
          'when answer is not exactly equal to rule reference',
          function() {
            ...
            it('should should return false', function() {
              ...
              expect(service.run(Mock.rule, '0')).toBe(
                false);
              expect(service.run(Mock.rule, 'a value')).toBe(
                false);
            });
        ...
        describe('when answer is within in rule answers',
          function() {
            ...
            it('should return true', function() {
              ...
              expect(service.run(Mock.rule, '5')).toBe(
                true);
            });
        ...
        describe('when answer is not within in rule answers',
          function() {
            ...
            it('should should return true', function() {
              ...
              expect(service.run(Mock.rule, '0')).toBe(
                false);
              expect(service.run(Mock.rule, 2)).toBe(
                false);
              expect(service.run(Mock.rule, '2')).toBe(
                false);
              expect(service.run(Mock.rule, 7)).toBe(
                false);
              expect(service.run(Mock.rule, '7')).toBe(
                false);
              expect(service.run(Mock.rule, 'a value')).toBe(
      ...
      xdescribe('greater cases', function() {
        ...
        describe(
          'when answer is not greater than rule reference',
          function() {
      ...
      xdescribe('greaterEqual cases', function() {
        ...
        describe(
          'when answer is greater or equal to rule reference',
          function() {
        ...
        describe(
          'when answer is not greater or equal to rule reference',
          function() {
      ...
      xdescribe('lower cases', function() {
            ...
            it('should return false', function() {
              ...
              describe('TextRuleTestService', function() {
                ...
                describe('run method', function() {
                  ...
                  describe(
                    'when inputed answer is not an Integer',
                    function() {
                  ...
                  describe(
                    'when inputed answer is an Integer',
                    function() {
                      ...
                      describe('within cases',
                        function() {
                          ...
                          describe(
                            'when answer is within in rule answers',
                            function() {
                          ...
                          describe(
                            'when answer is not within in rule answers',
                            function() {
                      ...
                      describe('greater cases',
                        function() {
                          ...
                          describe(
                            'when answer is greater than rule reference',
                            function() {
                      ...
                      describe('lower cases',
                        function() {
                          ...
                          describe(
                            'when answer is lower than rule reference',
                            function() {
                          ...
                          describe(
                            'when answer is not lower than rule reference',
                            function() {
                      ...
                      describe(
                        ...
                        function() {
                          ...
                          describe(
                            'when answer is lower or equal to rule reference',
                            function() {
                          ...
                          describe(
                            'when answer is not lower or equal to rule reference',
                            function() {
                      ...
                      describe('between cases',
                        function() {
                          ...
                          describe(
                            'when answer is between the rule answers',
                            function() {
                          ...
                          describe(
                            'when answer is not between the rule answers',
                            function() {
      ...
      xdescribe('lowerEqual cases', function() {
        ...
        describe('when answer is not between the rule answers',
          function() {
            ...
            it('should should return true', function() {
              ...
              expect(service.run(Mock.rule, '0')).toBe(
                false);
              expect(service.run(Mock.rule, 4)).toBe(
                false);
              expect(service.run(Mock.rule, '4')).toBe(
                false);
              expect(service.run(Mock.rule, 5)).toBe(
